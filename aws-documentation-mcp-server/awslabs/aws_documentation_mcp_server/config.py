...
"""AWS Documentation MCP Server 설정 모듈."""
...
def get_transport_from_env() -> Literal['stdio', 'streamable-http']:
    ...
    transport = os.getenv('AWS_DOCS_MCP_TRANSPORT', 'stdio')
...
HOST = os.getenv('AWS_DOCS_MCP_HOST', '0.0.0.0')
PORT = int(os.getenv('AWS_DOCS_MCP_PORT', '8000'))
